...
class Wechat:
	def __init__(self):
		self.CORPID = 'wwf246537828b85a93'
		#self.CORPID = 'wwe1cfc646b5e4823b'
		self.CORPSECRET = 'L64SkM7QQgftXfd6NEcAKLMo9SOak0w6Wyh8QQjgHxs'
	...
	def send_data(self, message):
		...
		r = requeste.post(send_url, send_data.encode())
		print (r.content)
		return r.content
